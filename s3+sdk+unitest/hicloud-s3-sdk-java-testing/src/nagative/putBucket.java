...
public class putBucket{
    ...
    {
    	System.out.println("region put bucket");
 ...
 /*           System.out.println("Listing buckets");
    ...
    private static void sRegionPutBucket() throws IOException
    {
    	System.out.println("region put bucket");
 ...
 /*           System.out.println("Listing buckets");
    ...
    private static void aPutBucket() throws IOException
    {
    ...
    public static void main(String args[]) throws IOException
	{
		...
		//basicPutBucket();
		//regionPutBucket(); // NOT COMPATITABLE
		//sRegionPutBucket();
		aPutBucket(); //with canned acl
	}
